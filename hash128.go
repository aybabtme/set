...
var (
	hash128IsMutable MutableSet = NewHashFunc128(0, farm.Hash128)
)

// NewSpooky128 is a Hash128 with spooky hash for hasher.
func NewSpooky128(n int) *Hash128 {
	return NewHashFunc128(n, func(b []byte) (lo, hi uint64) { spooky.Hash128(b, &lo, &hi); return })
}

// NewFarm128 is a Hash128 with farmhash for hasher.
func NewFarm128(n int) *Hash128 { return NewHashFunc128(n, farm.Hash128) }
...
func NewHashFunc128(n int, fh128 func(s []byte) (uint64, uint64)) *Hash128 {
	return &Hash128{
...
func (m *Hash128) Add(s string) { m.m[m.get128Block(s)] = q }
